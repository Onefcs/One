const SPRITE_DEF = {
  deathknight: {
    ...
    anims: {
      'front-idle':   { src:'images/DeathKnight/Front - Idle.png',      cols:15, rows:1, n:15, fps:7,  loop:true  },
      'back-idle':    { src:'images/DeathKnight/Back - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'left-idle':    { src:'images/DeathKnight/Left - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'right-idle':   { src:'images/DeathKnight/Right - Idle.png',       cols:15, rows:1, n:15, fps:7,  loop:true  },
      'front-run':    { src:'images/DeathKnight/Front - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'back-run':     { src:'images/DeathKnight/Back - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'left-run':     { src:'images/DeathKnight/Left - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'right-run':    { src:'images/DeathKnight/Right - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'front-attack': { src:'images/DeathKnight/Front - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'back-attack':  { src:'images/DeathKnight/Back - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'left-attack':  { src:'images/DeathKnight/Left - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'right-attack': { src:'images/DeathKnight/Right - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'die':          { src:'images/DeathKnight/Dying.png',              cols:15, rows:1, n:15, fps:12, loop:false },
    }
  },
  ranger: {
    frameW: 128, frameH: 128,
    anims: {
      'front-idle':   { src:'images/Ranger/Front - Idle.png',      cols:15, rows:1, n:15, fps:7,  loop:true  },
      'back-idle':    { src:'images/Ranger/Back - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'left-idle':    { src:'images/Ranger/Left - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'right-idle':   { src:'images/Ranger/Right - Idle.png',       cols:15, rows:1, n:15, fps:7,  loop:true  },
      'front-run':    { src:'images/Ranger/Front - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'back-run':     { src:'images/Ranger/Back - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'left-run':     { src:'images/Ranger/Left - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'right-run':    { src:'images/Ranger/Right - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'front-attack': { src:'images/Ranger/Front - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'back-attack':  { src:'images/Ranger/Back - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'left-attack':  { src:'images/Ranger/Left - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'right-attack': { src:'images/Ranger/Right - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'die':          { src:'images/Ranger/Dying.png',              cols:15, rows:1, n:15, fps:12, loop:false },
    }
  },
  mage: {
    frameW: 128, frameH: 128,
    anims: {
      'front-idle':   { src:'images/Mage/Front - Idle.png',      cols:15, rows:1, n:15, fps:7,  loop:true  },
      'back-idle':    { src:'images/Mage/Back - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'left-idle':    { src:'images/Mage/Left - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'right-idle':   { src:'images/Mage/Right - Idle.png',       cols:15, rows:1, n:15, fps:7,  loop:true  },
      'front-run':    { src:'images/Mage/Front - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'back-run':     { src:'images/Mage/Back - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'left-run':     { src:'images/Mage/Left - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'right-run':    { src:'images/Mage/Right - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'front-attack': { src:'images/Mage/Front - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'back-attack':  { src:'images/Mage/Back - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'left-attack':  { src:'images/Mage/Left - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'right-attack': { src:'images/Mage/Right - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'die':          { src:'images/Mage/Dying.png',              cols:15, rows:1, n:15, fps:12, loop:false },
    }
  },
  warlock: {
    frameW: 128, frameH: 128,
    anims: {
      'front-idle':   { src:'images/Warlock/Front - Idle.png',      cols:15, rows:1, n:15, fps:7,  loop:true  },
      'back-idle':    { src:'images/Warlock/Back - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'left-idle':    { src:'images/Warlock/Left - Idle.png',        cols:15, rows:1, n:15, fps:7,  loop:true  },
      'right-idle':   { src:'images/Warlock/Right - Idle.png',       cols:15, rows:1, n:15, fps:7,  loop:true  },
      'front-run':    { src:'images/Warlock/Front - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'back-run':     { src:'images/Warlock/Back - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'left-run':     { src:'images/Warlock/Left - Running.png',     cols:15, rows:1, n:15, fps:15, loop:true  },
      'right-run':    { src:'images/Warlock/Right - Running.png',    cols:15, rows:1, n:15, fps:15, loop:true  },
      'front-attack': { src:'images/Warlock/Front - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'back-attack':  { src:'images/Warlock/Back - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'left-attack':  { src:'images/Warlock/Left - Attacking.png',   cols:15, rows:1, n:15, fps:14, loop:false },
      'right-attack': { src:'images/Warlock/Right - Attacking.png',  cols:15, rows:1, n:15, fps:14, loop:false },
      'die':          { src:'images/Warlock/Dying.png',              cols:15, rows:1, n:15, fps:12, loop:false },
    }
  },
  lev: {
    frameW: 128, frameH: 128,
