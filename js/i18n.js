...
const I18N_UI = {
  ...
  coopRule1: { ru: 'Пати не нужна — нажмите «Войти», и система случайно найдёт вам напарника', en: 'No party needed — click Enter and the system randomly finds you a partner' },
