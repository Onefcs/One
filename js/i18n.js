...
const I18N_UI = {
  ...
  farm2Rule4: { ru: '2 комнаты по 50 агрессивных монстров, вдвое сильнее и быстрее обычных', en: '2 rooms of 50 aggressive monsters each, twice as strong and twice as fast as ordinary ones' },
  ...
  farm2Drop2: { ru: 'Редкий бокс — 0.0001%', en: 'Rare box — 0.0001%' },
  farm2Drop3: { ru: 'Необычный бокс — 0.001%', en: 'Uncommon box — 0.001%' },
  farm2Drop4: { ru: 'Обычная заточка — 0.03%', en: 'Regular sharpening stone — 0.03%' },
  farm2Drop5: { ru: 'Безопасная заточка — 0.006%', en: 'Safe sharpening stone — 0.006%' },
  farm2Drop6: { ru: 'Рецепт эпический — 0.1%, легендарный — 0.01%', en: 'Epic recipe — 0.1%, legendary — 0.01%' },
  farm2Drop7: { ru: 'Опыт — 1000 с монстра', en: 'XP — 1000 per monster' },
  farm2Drop8: { ru: 'Книги второй профессии — 0.005%', en: 'Second-profession books — 0.005%' },
