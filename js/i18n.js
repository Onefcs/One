...
const I18N_UI = {
  ...
  seasonTabPacks:  { ru: 'Паки', en: 'Packs', uk: 'Паки', es: 'Packs', tr: 'Paketler', pt: 'Pacotes' },
  seasonPkgPotionsFmt: { ru: 'по {n} каждой банки бафа', en: '{n} of every buff potion', uk: 'по {n} кожної банки бафа', es: '{n} de cada poción de buff', tr: 'her buff iksirinden {n} adet', pt: '{n} de cada poção de buff' },
  seasonPkgLabelFmt: { ru: 'Сезонный пак ({g} GRAM)', en: 'Season pack ({g} GRAM)', uk: 'Сезонний пак ({g} GRAM)', es: 'Pack de temporada ({g} GRAM)', tr: 'Sezon paketi ({g} GRAM)', pt: 'Pacote da temporada ({g} GRAM)' },
  seasonShopHdr:   { ru: 'Сезонные паки', en: 'Season packs', uk: 'Сезонні паки', es: 'Packs de temporada', tr: 'Sezon paketleri', pt: 'Pacotes da temporada' },
  ...
  fearAllBusy:  { ru: 'Все залы заняты', en: 'All halls are busy', uk: 'Усі зали зайняті', es: 'Todas las salas están ocupadas', tr: 'Tüm salonlar dolu', pt: 'Todas as salas estão ocupadas' },
  fearLanesFmt: { ru: 'Свободных залов: {n}/{max}', en: 'Free halls: {n}/{max}', uk: 'Вільних залів: {n}/{max}', es: 'Salas libres: {n}/{max}', tr: 'Boş salon: {n}/{max}', pt: 'Salas livres: {n}/{max}' },
...
Object.assign(I18N_UI, {
  ...
  rebirthDesc: { ru: 'Сбрасывает уровень до 1 и даёт +15 очков навыка навсегда. До 30 уровня новые очки навыка за левелап начисляться не будут — они снова начнут капать только с 30 уровня и дальше, как раньше.', en: 'Resets your level to 1 and grants +15 skill points forever. Levelling up gives no new skill points until level 30 — they start accruing again from level 30 onward, same as before.', uk: 'Скидає рівень до 1 і дає +15 очок навички назавжди. До 30 рівня нові очки навички за левелап не нараховуватимуться — вони знову почнуть капати лише з 30 рівня і далі, як раніше.', es: 'Reinicia tu nivel a 1 y otorga +15 puntos de habilidad para siempre. Subir de nivel no da nuevos puntos de habilidad hasta el nivel 30 — vuelven a acumularse desde el nivel 30 en adelante, igual que antes.', tr: 'Seviyeni 1\'e sıfırlar ve kalıcı olarak +15 yetenek puanı verir. Seviye 30\'a kadar seviye atlamak yeni yetenek puanı vermez — 30. seviyeden itibaren eskisi gibi yeniden birikmeye başlar.', pt: 'Reinicia seu nível para 1 e concede +15 pontos de habilidade para sempre. Subir de nível não dá novos pontos de habilidade até o nível 30 — eles voltam a acumular a partir do nível 30, como antes.' },
  ...
  rebirthConfirmBody: { ru: 'Уровень сбросится до 1, все улучшения обнулятся, а взамен вы получите +15 очков навыка навсегда. Указанные предметы будут потрачены. Действие необратимо.', en: 'Your level resets to 1 and every upgrade goes to zero, in exchange for +15 skill points forever. The listed items will be consumed. This cannot be undone.', uk: 'Рівень скинеться до 1, усі покращення обнуляться, натомість ви отримаєте +15 очок навички назавжди. Вказані предмети буде витрачено. Дію не можна скасувати.', es: 'Tu nivel se reinicia a 1 y todas las mejoras se ponen a cero, a cambio de +15 puntos de habilidad para siempre. Los objetos indicados se consumirán. Esto no se puede deshacer.', tr: 'Seviyen 1\'e sıfırlanır, tüm geliştirmeler sıfırlanır, karşılığında kalıcı olarak +15 yetenek puanı alırsın. Listelenen eşyalar harcanacak. Bu işlem geri alınamaz.', pt: 'Seu nível volta a 1 e todas as melhorias vão a zero, em troca de +15 pontos de habilidade para sempre. Os itens listados serão consumidos. Isso não pode ser desfeito.' },
  ...
  specialBtnLbl: { ru: 'Special', en: 'Special', uk: 'Special', es: 'Special', tr: 'Special', pt: 'Special' },
  specialShopHdr: { ru: 'Книги', en: 'Books', uk: 'Книги', es: 'Libros', tr: 'Kitaplar', pt: 'Livros' },
  specialChooseBtn: { ru: 'Выбрать', en: 'Choose', uk: 'Обрати', es: 'Elegir', tr: 'Seç', pt: 'Escolher' },
  specialBooksOfChoiceFmt: { ru: '{n} книг навыков на выбор', en: '{n} skill books of choice', uk: '{n} книг навичок на вибір', es: '{n} libros de habilidad a elegir', tr: '{n} seçilebilir yetenek kitabı', pt: '{n} livros de habilidade à escolha' },
