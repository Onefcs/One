...
Object.assign(I18N_UI, {
  ...
  empowerDesc: { ru: 'Даёт +15 очков навыка навсегда. Уровень, опыт и уже вложенные улучшения не сбрасываются — усиление только тратит указанные предметы. Повторяется сколько угодно раз, каждое 5-е стоит вдвое дороже.', en: 'Grants +15 skill points forever. Your level, XP and the upgrades you already invested are not reset — an empowerment only spends the listed items. Repeatable as many times as you like; every 5th one costs double.', uk: 'Дає +15 очок навички назавжди. Рівень, досвід і вже вкладені покращення не скидаються — посилення лише витрачає вказані предмети. Повторюється скільки завгодно разів, кожне 5-те коштує вдвічі дорожче.', es: 'Otorga +15 puntos de habilidad para siempre. Tu nivel, tu experiencia y las mejoras que ya invertiste no se reinician — una potenciación solo consume los objetos indicados. Repetible tantas veces como quieras; cada 5.ª cuesta el doble.', tr: 'Kalıcı olarak +15 yetenek puanı verir. Seviyen, tecrüben ve daha önce yatırdığın geliştirmeler sıfırlanmaz — güçlendirme yalnızca listelenen eşyaları harcar. İstediğin kadar tekrarlanır; her 5.\'si iki katına mal olur.', pt: 'Concede +15 pontos de habilidade para sempre. Seu nível, sua experiência e as melhorias que você já investiu não são reiniciados — uma potencialização apenas consome os itens listados. Repetível quantas vezes quiser; cada 5.ª custa o dobro.' },
  ...
  empowerDoubleCostFmt: { ru: 'Усиление №{n} — стоимость ×2!', en: 'Empowerment #{n} — cost ×2!', uk: 'Посилення №{n} — вартість ×2!', es: 'Potenciación n.º {n} — ¡coste ×2!', tr: 'Güçlendirme #{n} — maliyet ×2!', pt: 'Potencialização nº {n} — custo ×2!' },
