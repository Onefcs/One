...
const I18N_UI = {
  ...
  race10RewardHdr:{ ru: 'Награда победителю (больше всего урона боссу):', en: 'Reward for the winner (most boss damage):', uk: 'Нагорода переможцю (найбільше шкоди босу):', es: 'Recompensa para el ganador (más daño al jefe):', tr: 'Kazanana ödül (en çok patron hasarı):', pt: 'Recompensa ao vencedor (mais dano ao chefe):' },
