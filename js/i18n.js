...
Object.assign(I18N_UI, {
  ...
  techGiftModalTitle: { ru: '🎁 Технический подарок', en: '🎁 Tech gift', uk: '🎁 Технічний подарунок', es: '🎁 Regalo técnico', tr: '🎁 Teknik hediye', pt: '🎁 Presente técnico' },
  techGiftModalDesc: { ru: 'Разовый подарок, доступный каждому аккаунту один раз', en: 'A one-time gift, available once per account', uk: 'Разовий подарунок, доступний кожному акаунту один раз', es: 'Un regalo único, disponible una vez por cuenta', tr: 'Her hesaba bir kez verilen tek seferlik hediye', pt: 'Um presente único, disponível uma vez por conta' },
  techGiftClaimBtn: { ru: 'Забрать', en: 'Claim', uk: 'Забрати', es: 'Reclamar', tr: 'Al', pt: 'Resgatar' },
