...
Object.assign(I18N_UI, {
  ...
  upgResetCarried: { ru: 'Ещё {n} очк. держит перерождение — они вернутся сами по мере прокачки до {lvl} уровня.', en: 'Another {n} points are held by your rebirth — they come back on their own as you level to {lvl}.', uk: 'Ще {n} очок тримає переродження — вони повернуться самі, коли досягнеш {lvl} рівня.', es: 'El renacimiento retiene otros {n} puntos: vuelven por sí solos al subir al nivel {lvl}.', tr: '{n} puanı daha yeniden doğuş tutuyor — {lvl}. seviyeye çıktıkça kendiliğinden geri gelir.', pt: 'Outros {n} pontos ficam retidos pelo renascimento — eles voltam sozinhos ao subir para o nível {lvl}.' },
  upgResetCarriedAll: { ru: 'Сброс сейчас ничего не вернёт: все очки держит перерождение — они вернутся с уровнями до {lvl}.', en: 'A reset would return nothing right now: your rebirth holds every point — they come back as you level to {lvl}.', uk: 'Скидання зараз нічого не поверне: усі очки тримає переродження — вони повернуться з рівнями до {lvl}.', es: 'Restablecer ahora no devolvería nada: el renacimiento retiene todos los puntos; vuelven al subir al nivel {lvl}.', tr: 'Şimdi sıfırlamak hiçbir şey iade etmez: tüm puanları yeniden doğuş tutuyor — {lvl}. seviyeye çıktıkça geri gelirler.', pt: 'Redefinir agora não devolveria nada: o renascimento retém todos os pontos — eles voltam ao subir para o nível {lvl}.' },
