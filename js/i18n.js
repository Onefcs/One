...
Object.assign(I18N_UI, {
  ...
  classChangeTabLbl: { ru: 'Смена класса', en: 'Change Class', uk: 'Зміна класу', es: 'Cambiar clase', tr: 'Sınıf Değiştir', pt: 'Mudar Classe' },
  classChangeDescFmt: { ru: 'Смените класс персонажа за {n} GRAM. Уровень, опыт и улучшения сохранятся, навыки перенесутся на том же уровне. Вся экипировка будет автоматически снята в инвентарь.', en: 'Change your character\'s class for {n} GRAM. Level, XP and upgrades stay as they are — skills carry over at the same level. All equipment is automatically unequipped into your inventory.', uk: 'Змініть клас персонажа за {n} GRAM. Рівень, досвід і покращення збережуться, навички перенесуться на тому ж рівні. Вся екіпіровка буде автоматично знята в інвентар.', es: 'Cambia la clase de tu personaje por {n} GRAM. El nivel, la experiencia y las mejoras se mantienen — las habilidades pasan al mismo nivel. Todo el equipo se desequipa automáticamente a tu inventario.', tr: 'Karakterinin sınıfını {n} GRAM karşılığında değiştir. Seviye, XP ve geliştirmeler korunur — yetenekler aynı seviyede aktarılır. Tüm ekipman otomatik olarak envantere çıkarılır.', pt: 'Mude a classe do seu personagem por {n} GRAM. Nível, XP e melhorias permanecem — as habilidades passam no mesmo nível. Todo o equipamento é automaticamente desequipado para o inventário.' },
  classChangeUnequipWarnFmt: { ru: 'Экипированные предметы ({n}) будут сняты в инвентарь', en: 'Equipped items ({n}) will be unequipped into your inventory', uk: 'Екіпіровані предмети ({n}) буде знято в інвентар', es: 'Los objetos equipados ({n}) se desequiparán a tu inventario', tr: 'Ekipmanlı eşyalar ({n}) envantere çıkarılacak', pt: 'Itens equipados ({n}) serão desequipados para o inventário' },
  classChangeNoGramLbl: { ru: 'Недостаточно GRAM', en: 'Not enough GRAM', uk: 'Недостатньо GRAM', es: 'GRAM insuficiente', tr: 'Yetersiz GRAM', pt: 'GRAM insuficiente' },
  classChangeConfirmTitleFmt: { ru: 'Стать: {cls}?', en: 'Become: {cls}?', uk: 'Стати: {cls}?', es: '¿Convertirse en: {cls}?', tr: 'Şu sınıf ol: {cls}?', pt: 'Tornar-se: {cls}?' },
  classChangeConfirmBodyFmt: { ru: 'Спишется {n} GRAM. Уровень и улучшения сохранятся, навыки перейдут на этот класс с теми же уровнями.', en: '{n} GRAM will be charged. Level and upgrades stay as they are — skills carry over to this class at the same levels.', uk: 'Спишеться {n} GRAM. Рівень і покращення збережуться, навички перейдуть на цей клас з тими ж рівнями.', es: 'Se cobrarán {n} GRAM. El nivel y las mejoras se mantienen — las habilidades pasan a esta clase con los mismos niveles.', tr: '{n} GRAM tahsil edilecek. Seviye ve geliştirmeler korunur — yetenekler aynı seviyelerle bu sınıfa aktarılır.', pt: '{n} GRAM serão cobrados. Nível e melhorias permanecem — as habilidades passam para esta classe nos mesmos níveis.' },
  classChangeGo: { ru: 'Сменить класс', en: 'Change Class', uk: 'Змінити клас', es: 'Cambiar clase', tr: 'Sınıfı Değiştir', pt: 'Mudar Classe' },
  classChangeDoneToast: { ru: '✓ Класс изменён!', en: '✓ Class changed!', uk: '✓ Клас змінено!', es: '✓ ¡Clase cambiada!', tr: '✓ Sınıf değiştirildi!', pt: '✓ Classe alterada!' },
