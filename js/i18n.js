...
Object.assign(I18N_UI, {
  ...
  evtBossIncomingFmt: { ru: '⚔️ Через {time} босс появится в безопасной зоне', en: '⚔️ A boss appears in the safe zone in {time}', uk: '⚔️ Через {time} бос з\'явиться в безпечній зоні', es: '⚔️ Un jefe aparecerá en la zona segura en {time}', tr: '⚔️ {time} sonra güvenli bölgede bir boss belirecek', pt: '⚔️ Um chefe aparecerá na zona segura em {time}' },
  evtBossArrived: { ru: '🔥 Босс появился!', en: '🔥 The boss has appeared!', uk: '🔥 Бос з\'явився!', es: '🔥 ¡El jefe ha aparecido!', tr: '🔥 Boss belirdi!', pt: '🔥 O chefe apareceu!' },
