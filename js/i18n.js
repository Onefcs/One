...
const I18N_UI = {
  ...
  race10LibertyRewardNote: { ru: 'Liberty — только победителю (больше всего урона боссу)', en: 'Liberty — winner only (most boss damage)', uk: 'Liberty — лише переможцю (найбільше шкоди босу)', es: 'Liberty — solo para el ganador (más daño al jefe)', tr: 'Liberty — yalnızca kazanana (en çok patron hasarı)', pt: 'Liberty — só para o vencedor (mais dano ao chefe)' },
