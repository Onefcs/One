...
const I18N_UI = {
  ...
  coopPhaseWaitingPartner: { ru: 'Ждём напарника...', en: 'Waiting for partner...' },
  coopNeedPartyMsg: { ru: 'Нужна пати ровно из 2 игроков', en: 'Need a party of exactly 2' },
  ...
  coopRule1: { ru: 'Нужна пати ровно из 2 игроков — оба должны нажать «Войти»', en: 'Need a party of exactly 2 — both must click Enter' },
