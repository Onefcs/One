...
const I18N_UI = {
  ...
  season2Desc: {
    ...
    en: 'The season points race: enhance your gear, craft profession books, burn junk, invite friends, empower your character, and buy on the market — the best players win prizes.',
    ...
    es: 'La carrera de puntos de temporada: mejora tu equipo, crea libros de profesión, quema lo que no sirve, invita amigos, potencia tu personaje y compra en el mercado — los mejores ganan premios.',
    tr: 'Sezon puan yarışı: eşyanı geliştir, meslek kitapları hazırla, gereksizleri yak, arkadaş davet et, güçlen ve pazardan alışveriş yap — en iyiler ödül kazanır.',
    pt: 'A corrida de pontos da temporada: aprimore seu equipamento, crie livros de profissão, queime o que não serve, convide amigos, potencialize e compre no mercado — os melhores ganham prêmios.',
  },
  ...
  season2EmpowerFmt: {
    ru: 'Усиление — +{n} очков', en: 'Empowerment — +{n} points', uk: 'Посилення — +{n} очок',
    es: 'Potenciación — +{n} puntos', tr: 'Güçlendirme — +{n} puan', pt: 'Potencialização — +{n} pontos',
  },
  season2ShopFmt: {
  ...
  seasonTasksRepeat: { ru: 'Выполняются повторно — каждый раз снова приносят очки', en: 'Repeatable — they pay again every time', uk: 'Виконуються повторно — щоразу знову дають очки', es: 'Repetibles: dan puntos cada vez', tr: 'Tekrarlanabilir — her seferinde yine puan verir', pt: 'Repetíveis — pagam de novo a cada vez' },
  ...
  seasonEnhRare:     { ru: 'Заточка редкого предмета — +{n} очков', en: 'Enhancing a rare item — +{n} points', uk: 'Заточка рідкісного предмета — +{n} очок', es: 'Mejorar un objeto raro: +{n} puntos', tr: 'Ender eşya geliştirme — +{n} puan', pt: 'Aprimorar item raro — +{n} pontos' },
  ...
  seasonTierLvlFmt:    { ru: 'монстры {a}-{b} ур.', en: 'monsters lv. {a}-{b}', uk: 'монстри {a}-{b} рів.', es: 'monstruos niv. {a}-{b}', tr: '{a}-{b}. sv. canavarlar', pt: 'monstros nív. {a}-{b}' },
  seasonTierLockedFmt: { ru: 'с {n} уровня', en: 'from level {n}', uk: 'з {n} рівня', es: 'desde el nivel {n}', tr: '{n}. seviyeden', pt: 'a partir do nível {n}' },
  seasonTierLockedMsg: { ru: 'Нужен {n} уровень', en: 'Requires level {n}', uk: 'Потрібен {n} рівень', es: 'Requiere el nivel {n}', tr: '{n}. seviye gerekli', pt: 'Requer nível {n}' },
  ...
  coopPhaseIdle: { ru: 'Войдите, чтобы начать', en: 'Enter to begin' },
  ...
  questEnhanceHint: { ru: 'Заточи любой предмет до +{n} у кузнеца', en: 'Enhance any item to +{n} at the blacksmith', uk: 'Загостри будь-який предмет до +{n} у коваля', es: 'Mejora cualquier objeto hasta +{n} en el herrero', tr: 'Demircide herhangi bir eşyayı +{n} seviyesine yükselt', pt: 'Aprimore qualquer item até +{n} no ferreiro' },
...
Object.assign(I18N_UI, {
  ...
  empowerDesc: { ru: 'Даёт +15 очков навыка навсегда. Уровень, опыт и уже вложенные улучшения не сбрасываются — усиление только тратит указанные предметы. Стоимость растёт по этапам (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). Максимум — 30 усилений.', en: 'Grants +15 skill points forever. Your level, XP and the upgrades you already invested are not reset — an empowerment only spends the listed items. Cost rises in stages (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). Capped at 30 empowerments.', uk: 'Дає +15 очок навички назавжди. Рівень, досвід і вже вкладені покращення не скидаються — посилення лише витрачає вказані предмети. Вартість зростає етапами (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). Максимум — 30 посилень.', es: 'Otorga +15 puntos de habilidad para siempre. Tu nivel, tu experiencia y las mejoras que ya invertiste no se reinician — una potenciación solo consume los objetos indicados. El coste sube por etapas (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). Máximo 30 potenciaciones.', tr: 'Kalıcı olarak +15 yetenek puanı verir. Seviyen, tecrüben ve daha önce yatırdığın geliştirmeler sıfırlanmaz — güçlendirme yalnızca listelenen eşyaları harcar. Maliyet aşamalı artar (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). En fazla 30 güçlendirme.', pt: 'Concede +15 pontos de habilidade para sempre. Seu nível, sua experiência e as melhorias que você já investiu não são reiniciados — uma potencialização apenas consome os itens listados. O custo sobe em etapas (1-4 ×1, 5-9 ×2, 10-14 ×4, 15-19 ×8, 20-24 ×26, 25-30 ×40). Máximo de 30 potencializações.' },
  empowerLevelReqFmt: { ru: 'Уровень {cur} / {lvl} для усиления', en: 'Level {cur} / {lvl} to empower', uk: 'Рівень {cur} / {lvl} для посилення', es: 'Nivel {cur} / {lvl} para potenciar', tr: 'Güçlendirmek için seviye {cur} / {lvl}', pt: 'Nível {cur} / {lvl} para potencializar' },
  empowerNeedHubLbl: { ru: 'Усиление доступно только в Зале', en: 'Empowerment is only available in the Hall', uk: 'Посилення доступне лише в Залі', es: 'La potenciación solo está disponible en la Sala', tr: 'Güçlendirme sadece Salonda kullanılabilir', pt: 'A potencialização só está disponível no Salão' },
  empowerBtn: { ru: 'Усилиться', en: 'Empower', uk: 'Посилитися', es: 'Potenciar', tr: 'Güçlendir', pt: 'Potencializar' },
  empowerCountFmt: { ru: 'Усилений пройдено: {n}', en: 'Empowerments completed: {n}', uk: 'Посилень пройдено: {n}', es: 'Potenciaciones completadas: {n}', tr: 'Tamamlanan güçlendirme: {n}', pt: 'Potencializações concluídas: {n}' },
  empowerCostMultFmt: { ru: 'Усиление №{n} — стоимость ×{mult}!', en: 'Empowerment #{n} — cost ×{mult}!', uk: 'Посилення №{n} — вартість ×{mult}!', es: 'Potenciación n.º {n} — ¡coste ×{mult}!', tr: 'Güçlendirme #{n} — maliyet ×{mult}!', pt: 'Potencialização nº {n} — custo ×{mult}!' },
  empowerMaxReachedFmt: { ru: 'Достигнут максимум усилений: {max}', en: 'Maximum empowerments reached: {max}', uk: 'Досягнуто максимум посилень: {max}', es: 'Máximo de potenciaciones alcanzado: {max}', tr: 'Maksimum güçlendirmeye ulaşıldı: {max}', pt: 'Máximo de potencializações atingido: {max}' },
  empowerMatPkgLabel_rmat1: { ru: 'Набор I', en: 'Set I', uk: 'Набір I', es: 'Set I', tr: 'Set I', pt: 'Conjunto I' },
  empowerMatPkgLabel_rmat2: { ru: 'Набор II', en: 'Set II', uk: 'Набір II', es: 'Set II', tr: 'Set II', pt: 'Conjunto II' },
  empowerMatPkgLabel_rmat3: { ru: 'Набор III', en: 'Set III', uk: 'Набір III', es: 'Set III', tr: 'Set III', pt: 'Conjunto III' },
  empowerConfirmTitle: { ru: 'Усиление', en: 'Empowerment', uk: 'Посилення', es: 'Potenciación', tr: 'Güçlendirme', pt: 'Potencialização' },
  empowerConfirmBody: { ru: 'Вы получите +15 очков навыка навсегда. Уровень, опыт и улучшения останутся как есть. Указанные предметы будут потрачены. Действие необратимо.', en: 'You gain +15 skill points forever. Your level, XP and upgrades stay exactly as they are. The listed items will be consumed. This cannot be undone.', uk: 'Ви отримаєте +15 очок навички назавжди. Рівень, досвід і покращення залишаться як є. Вказані предмети буде витрачено. Дію не можна скасувати.', es: 'Ganas +15 puntos de habilidad para siempre. Tu nivel, tu experiencia y tus mejoras se mantienen igual. Los objetos indicados se consumirán. Esto no se puede deshacer.', tr: 'Kalıcı olarak +15 yetenek puanı kazanırsın. Seviyen, tecrüben ve geliştirmelerin olduğu gibi kalır. Listelenen eşyalar harcanacak. Bu işlem geri alınamaz.', pt: 'Você ganha +15 pontos de habilidade para sempre. Seu nível, sua experiência e suas melhorias permanecem como estão. Os itens listados serão consumidos. Isso não pode ser desfeito.' },
  empowerGo: { ru: 'Усилиться', en: 'Empower', uk: 'Посилитися', es: 'Potenciar', tr: 'Güçlendir', pt: 'Potencializar' },
  empowerDoneToast: { ru: '✓ Вы усилились! +15 очков навыка', en: '✓ You have been empowered! +15 skill points', uk: '✓ Ви посилилися! +15 очок навички', es: '✓ ¡Te has potenciado! +15 puntos de habilidad', tr: '✓ Güçlendin! +15 yetenek puanı', pt: '✓ Você foi potencializado! +15 pontos de habilidade' },
  ...
  shopTabEmpower: { ru: 'Усиление', en: 'Empowerment', uk: 'Посилення', es: 'Potenciación', tr: 'Güçlendirme', pt: 'Potencialização' },
  ...
  empowerTabLbl: { ru: 'Усиление', en: 'Empowerment', uk: 'Посилення', es: 'Potenciación', tr: 'Güçlendirme', pt: 'Potencialização' },
...
const I18N_QUEST_TPL = {
  en: {
    ...
    enhance: (n) => `Enhance an item to +${n}`,
  },
  uk: {
    ...
    enhance: (n) => `Загостри предмет до +${n}`,
  },
  es: {
    ...
    enhance: (n) => `Mejora un objeto hasta +${n}`,
  },
  tr: {
    ...
    enhance: (n) => `Bir eşyayı +${n} seviyesine yükselt`,
  },
  pt: {
    ...
    enhance: (n) => `Aprimore um item até +${n}`,
  },
};
function _questDescFor(q, lang) {
  ...
  switch (q.type) {
    ...
    case 'enhance': return tpl.enhance(q.enhance);
