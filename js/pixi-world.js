...
function _updateEnemyObj(e, obj, dt, pulse, bossGlow) {
  ...
  // frame or two — a visible hitch. The 2D canvas draws text at native screen
  // resolution every frame for free by comparison (same fix already applied
  // to player name tags — see _drawOtherPlayerNamesOnUI).
  e._nameBarTop = by;
}
