const { generateHub, generateArm, generateGuildWar } = require('./dungeon');
...
// 4 leveling arms and (as of this pass) Guild War are split out — the
// remaining special zones (boss arena, 3v3, race10, fear, farmZone) still
// live bundled inside generateHub() (see dungeon.js) until they get their own
// floor ids in later passes.
const FLOOR_IDS = { hub: 1, left: 2, top: 3, bottom: 4, right: 5, guildWar: 6 };
